 ...
 * @author gaurs
 */
@WebServlet(urlPatterns = {"/EditInventory"})
public class EditInventory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditInventory</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EditInventory at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
          ...
          stmt.executeUpdate("update inventory set itemName ='"+name+"', itemImage ='"+image+"', itemCategory = '"+category+"', itemQuantity ='"+quantity+"',itemUnit = '"+unit+"',itemUnitPrice='"+price+"',itemStatus = '"+status+"'"
                  + "where itemID = '"+id+"'");
          ...
          response.sendRedirect("InventoryPage.jsp");       
                ...
                {
                   response.sendRedirect("ErrorPage5.html");
                }
